            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2>@lang('frontend.shop_by_sub_categorie')</h2>
                        <div class="breadcrumb__option">
                            <a href="{{'/'}}">@lang('frontend.home')</a><a href="#">Shop By Categories</a>
                            <span>@if($lang == 'en'){{$sub_categories->sub_cat_name_en}}@elseif($lang == 'bn'){{$sub_categories->sub_cat_name_bn}}@endif</span>
                        </div>
                    </div>
                </div>
            </div>
