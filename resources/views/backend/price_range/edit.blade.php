...
<div class="container">
        ...
        @component('components.breadcrumb')
            @slot('title')
                @lang('price_range.edit_price_range')
            @endslot
            @slot('breadcrumb1')
        ...
        <form class="row" method="post" action="{{route('price_range.update',$data->id)}}">
            @csrf
            @method('PUT')
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">@lang('price_range.edit_price_range')</h4>
                        <div class="tab-content">
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
                                    ...
                                    <input type="text" name="from" placeholder="@lang('price_range.from')" class="form-control" value="{{$data->from}}" required>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
                                    <label class="mb-2">@lang('price_range.to') : <span class="text-danger">*</span></label>
                                    <input type="text" name="to" placeholder="@lang('price_range.to')" class="form-control" value="{{$data->to}}" required>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
                                    <label class="mb-2">@lang('price_range.order_by') : <span class="text-danger">*</span></label>
                                    <input type="text" name="order_by" placeholder="@lang('price_range.order_by')" class="form-control" value="{{$data->order_by}}" required>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
