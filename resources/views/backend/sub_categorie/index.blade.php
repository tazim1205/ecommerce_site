...
@section('content')
    <div class="container">
        ...
        @component('components.breadcrumb')
            @slot('title')
                @lang('sub_categorie.view_sub_categorie')
            @endslot
            @slot('breadcrumb1')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">@lang('sub_categorie.view_sub_categorie')</h4>
                                ...
                                <table id="alternative-page-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('subcategorie_restore') }}/{{ $v->id }}" class="btn btn-sm btn-info">@lang('common.restore')</a>
                                                <a href="{{ url('subcategorie_delete') }}/{{ $v->id }}" class="btn btn-sm btn-danger">@lang('common.permenantly_delete')</a>  
                                            </td> 
                                        </tr>
                                        @endforeach
                                        @endif
