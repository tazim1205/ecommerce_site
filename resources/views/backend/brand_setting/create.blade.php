...
<div class="container">
        ...
        @component('components.breadcrumb')
            @slot('title')
                @lang('brand_setting.create_brand')
            @endslot
            @slot('breadcrumb1')
        ...
        <form class="row" method="post" action="{{route('brand_setting.store')}}">
            @csrf
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">@lang('brand_setting.add_brand')</h4>
                        <div class="tab-content">
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
                                    ...
                                    <input type="text" name="brand_name_en" placeholder="@lang('brand_setting.brand_name_en')" class="form-control" value="{{ old('brand_name_en') }}" required>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
                                    <label class="mb-2">@lang('brand_setting.brand_name_bn') : <span class="text-danger">*</span></label>
                                    <input type="text" name="brand_name_bn" placeholder="@lang('brand_setting.brand_name_bn')" class="form-control" value="{{ old('brand_name_bn') }}" required>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
                                    <label class="mb-2">@lang('brand_setting.order_by') : <span class="text-danger">*</span></label>
                                    <input type="text" name="order_by" placeholder="@lang('brand_setting.order_by')" class="form-control" value="{{ old('order_by') }}" required>
                                </div>
                                <div class="form-group col-sm-12 col-md-12 col-lg-6 mt-3">
