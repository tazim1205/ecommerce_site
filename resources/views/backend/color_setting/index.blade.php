...
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">@lang('color_setting.view_color')</h4>
                        ...
                        <div class="tab-content">
                                ...
                                <table class="table table-striped dt-responsive nowrap w-100" id="myTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@lang('color_setting.color_name')</th>
                                            <th>@lang('color_setting.order_by')</th>
                            ...
                            <div class="tab-pane" id="users-tab-deleted">
                                ...
                                $trashed=  color_setting::onlyTrashed()->get();
                                $sl=1;
                                @endphp
                                ...
                                <table id="alternative-page-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('color_restore') }}/{{ $v->id }}" class="btn btn-sm btn-info">@lang('common.restore')</a>
                                                <a href="{{ url('color_delete') }}/{{ $v->id }}" class="btn btn-sm btn-danger">@lang('common.permenantly_delete')</a>  
                                            </td> 
                                        </tr>
                                        @endforeach
                                        @endif
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('#myTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('color_setting.index') }}",
                columns: [
                    {data: 'sl', name: 'sl'},
  ...
  <script>
        function colorStatusChange(id)
        {
            ...
            if(id > 0)
            {
                var message = @json( __('color_setting.status_message') );
