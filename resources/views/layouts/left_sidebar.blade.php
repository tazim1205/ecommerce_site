...
<div class="leftside-menu">
    ...
    <a href="/dashboard" class="logo text-center logo-light">
        <span class="logo-lg">
            <img src="{{ asset('assets/images/site_settings/')}}/{{ $v->image }}" alt="" height="50">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('assets/images/site_settings/')}}/{{ $v->image }}" alt="" height="15">
        </span>
    </a>
    ...
    <a href="/dashboard" class="logo text-center logo-dark">
        <span class="logo-lg">
            <img src="{{ asset('assets/images/site_settings/')}}/{{ $v->image }}" alt="" height="16">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('assets/images/site_settings/')}}/{{ $v->image }}" alt="" height="16">
        </span>
